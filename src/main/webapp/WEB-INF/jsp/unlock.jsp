...
<p style="line-height:28px;padding-left:8px">
  ...
  <a href="#" style="color:black; font-size:13px"><span class="glyphicon glyphicon-chevron-right" style="font-size:13px"></span> Rates</a><br>
    ...
    <p style="font-size:20px;font-family:Times New Roman">Do you want to unlock your card?</p>
<a class="w3-btn w3-hover-green" href="wattounlock" class="button1">Unlock</a>

<a class="w3-btn w3-hover-red" href="welcome" class="button2">Cancel</a>
  </div>
</div>
