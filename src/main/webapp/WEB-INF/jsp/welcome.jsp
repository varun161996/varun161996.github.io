...
<hr>
<p style="line-height:28px;padding-left:8px">
  <a href="subscribe" style="color:black; font-size:13px"><span class="glyphicon glyphicon-chevron-right" style="font-size:13px"></span> Card Lock Service<br/></a>
...
<p style="line-height:28px;padding-left:8px">
 ...
 <p style="margin-left:1%;font-family:Times New Roman;font-size:24px;color:darkblue "><b>Welcome <% String value1 = (String)request.getAttribute("name");
if(value1!=null)
out.println(value1);%>!!</b></p>
  </div>
</div>
