...
<hr>
<p style="line-height:28px;padding-left:8px">
  <a href="subscribe.html" style="color:black; font-size:13px"><span class="glyphicon glyphicon-chevron-right" style="font-size:13px"></span> Card Lock Service<br/>
  <a href="unlock.html" style="color:black; font-size:13px"><span class="glyphicon glyphicon-chevron-right" style="font-size:13px"></span> Unlock Debit Card</a><br>
</p><hr>
<p style="line-height:28px;padding-left:8px">
 ...
 <div class>
    <form action="/idoremail"> 
<p style="font-family: Times New Roman; font-size:20px">Select the card you want to unlock</p>
<br>
<select required>
<option disabled selected value style="text-align:center"> -- Select the card to be unlocked -- </option>
<option><% String value1 = (String)request.getAttribute("card1");
if(value1!=null)
out.println(value1);%></option>
<option><% String value2 = (String)request.getAttribute("card2");
if(value2!=null)
out.println(value2);%></option>
</select>
<div><br>
<input type="submit" value="Unlock" class="button1"> 
<div></br><br>
</form>
<p>The card will be automatically locked after the transaction is complete</p>
</div>
</div>
  </div>
</div>
