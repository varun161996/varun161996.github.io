...
<form action="/unlocked" method="POST">
Enter the OTP
<input type="text" name="otp" required>
<input type="submit" value="Next" class="w3-btn w3-border w3-hover-blue">
</form>
</br>
<form action="#" method="post">
<input type="submit" value="Resend OTP" class="w3-btn w3-border w3-hover-blue">
</form>
<br>
<br>
The OTP will expire in 240 seconds
  </div>
</div>
